          ...
          {transaction.map((item) => (
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              >
                ...
                />
                <div className="pl-3">
                  <div className="text-base font-semibold">{item.from.name}</div>
                  <div className="font-normal text-gray-500">
                    {item.createdAt}
                  </div>
                </div>
              </th>
              <td className="px-6 py-4"> {moment(item.createdAt).format("MMMM Do YYYY")}</td>
            ...
            onClick={() => handleOnClick(item.teacher,item._id)}
              ...
              <ShareProfit modal={modal} setModal={setModal} teacher={teacher} transaction_id={transaction_id} />
            </tr>
          ))}
        </tbody>
      </table>
